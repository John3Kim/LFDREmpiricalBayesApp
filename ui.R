...
shinyUI(fluidPage(theme = "main.css",
    ...
    wellPanel(h4("About"), 
              p("The LFDREmpiricalBayes Data Analysis Demo allows the users to
                test out the functions caution.parameter.actions and 
                SEL.caution.parameter given two sets of LFDR estimates.  This 
                RShiny app is based on the package LFDREmpiricalBayes and will 
                be available soon.")
              ),
    hr(),
